                ...
                {repoStats["SpotiFLAC-Next"] && (<CardContent className={`${projectCardContentClass} space-y-2`}>
                    ...
                    <div className="rounded-md border border-sky-500/25 bg-sky-500/8 px-3 py-2">
                      ...
                      <p className="text-xs leading-snug text-sky-700 dark:text-sky-300">
                        Этот проект выпущен в знак благодарности тем, кто поддержал SpotiFLAC на Ko-fi. Это не платный продукт, но он публикуется приватно через спонсорские посты.
                      </p>
                    </div>
                  </CardContent>)}
              </Card>
              ...
              <div className="flex h-full flex-col gap-1.5">
                ...
                <Card className={`${projectCardClass} flex-1`} onClick={() => openExternal("https://spotubedl.com/")}>
                  <CardHeader className={projectCardHeaderClass}>
                    ...
                    <CardDescription className={projectBodyClass}>
                      Скачивайте треки, альбомы, плейлисты и дискографии Spotify в форматах MP3/OGG/Opus.
                    </CardDescription>
                  </CardHeader>
                </Card>
              </div>
            ...
            <div className="flex flex-col md:flex-row w-full max-w-3xl bg-card rounded-xl border shadow-sm">
              ...
              <div className="flex-1 p-6 flex flex-col items-center justify-between border-b md:border-b-0 md:border-r space-y-6">
                <div className="flex flex-col items-center space-y-4">
                  <div className="h-32 flex items-center justify-center w-full relative">
                    <img src={KofiLogo} className="h-40 w-auto object-contain pointer-events-none mt-[-20px]" alt="DonationAlerts"/>
                  </div>
                  <h4 className="font-semibold text-foreground">Поддержка через DonationAlerts</h4>
                  <p className="text-sm text-muted-foreground text-center px-4">
                    Нравится проект? Вы можете поддержать его дальнейшую разработку, отправив донат.
                  </p>
                </div>
                <Button className="h-10 w-full text-sm font-semibold text-black gap-2 group bg-[#f58220] hover:bg-[#d6711a]" onClick={() => openExternal("https://dalink.to/fallnix")}>
              ...
              <div className="flex-1 p-6 flex flex-col items-center justify-between space-y-6">
                <div className="flex flex-col items-center space-y-4 w-full">
                  ...
                  <p className="text-sm text-muted-foreground text-center px-4">
                    Криптовалютные донаты также принимаются. Отсканируйте QR-код или скопируйте адрес.
                  </p>
                </div>
